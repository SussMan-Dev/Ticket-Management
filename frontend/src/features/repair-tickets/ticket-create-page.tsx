...
export function TicketCreatePage() {
  ...
  const form = useForm<TicketValues>({ resolver: zodResolver(ticketSchema), defaultValues: { customerId: initialCustomerId, deviceId: 0, title: "", customerIssue: "", initialCondition: "", accessoriesReceived: "", priority: "NORMAL", expectedDiagnosisAt: "", expectedCompletionAt: "", receiveNow: false } });
